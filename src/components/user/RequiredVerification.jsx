...
function RequiredVerification() {
  return (
    <div className="px-4 sm:px-6 py-6 sm:py-8 space-y-5 shadow-xl shadow-neutral-100 bg-white rounded-xl sm:flex justify-between items-center gap-8 w-fit h-fit">
      <div className="">
        <div>
          <h1 className="text-xl xl:text-2xl font-[510] flex items-center gap-2">
            <GoAlertFill className="text-primary-500" />
            Profile Verification Required
          </h1>
          <p className="max-sm:text-sm mt-1 font-light text-sm">
            Complete your profile to unlock all features and <br />
            secure your property investments.
          </p>
        </div>
        <div className="max-sm:text-sm grid grid-cols-1 gap-4 mt-5">
      ...
      <div className="sm:w-fit">
        <p className="max-sm:text-sm mb-2">60% Complete</p>
